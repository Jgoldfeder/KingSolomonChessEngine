...
private:
	...
	bb &= ~(1ll | (1 << 7) | (1LL << 56) | (1LL << 63));//corners
	rookMask[x] = bb;
	}
	}
	void initBishopMask(){
	...
	inline void pieceBoardToList(int current, bitBoard bb, Move moves[], moveBoard board,moveBoard attackBoard[]){//backshift is used to get the peices current square
	while (bb){
